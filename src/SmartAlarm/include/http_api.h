...
int http_send_req(const sock_t sock,const char * url,const char *domain, char * download_buff, unsigned int buffer_size);
unsigned int http_get_download_filesize(const char *str_body);
